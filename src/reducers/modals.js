...
const MODAL_CUSTOM_LOAD_FILE_FROM_CLOUD = 'customLoadFileFromCloud';
const MODAL_CUSTOM_LOAD_FILE_TO_COMPUTER = 'customLoadFileToComputer';
const MODAL_CUSTOM_LOAD_FILE_TO_CLOUD = 'customLoadFileToCloud';
...
const initialState = {
    ...
    [MODAL_CUSTOM_LOAD_FILE_FROM_CLOUD]: false,
    [MODAL_CUSTOM_LOAD_FILE_TO_COMPUTER]: false,
    [MODAL_CUSTOM_LOAD_FILE_TO_CLOUD]: false,
};
...
const openCustomLoadFileFromCloud = function () {
    return openModal(MODAL_CUSTOM_LOAD_FILE_FROM_CLOUD);
};
const openCustomLoadFileToComputer = function () {
    return openModal(MODAL_CUSTOM_LOAD_FILE_TO_COMPUTER);
};
const openCustomLoadFileToCloud = function () {
    return openModal(MODAL_CUSTOM_LOAD_FILE_TO_CLOUD);
};
...
const closeCustomLoadFileFromCloud = function () {
    return closeModal(MODAL_CUSTOM_LOAD_FILE_FROM_CLOUD);
};
const closeCustomLoadFileToComputer = function () {
    return closeModal(MODAL_CUSTOM_LOAD_FILE_TO_COMPUTER);
};
const closeCustomLoadFileToCloud = function () {
    return closeModal(MODAL_CUSTOM_LOAD_FILE_TO_CLOUD);
};
export {
    reducer as default,
