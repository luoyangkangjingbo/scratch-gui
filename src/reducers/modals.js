...
const MODAL_BAC_PROJECT_LIBRARY = 'BACProjectLibrary';
...
const initialState = {
    ...
    [MODAL_BAC_PROJECT_LIBRARY]: false
};
...
const openBACProjectLibrary = function () {
    return openModal(MODAL_BAC_PROJECT_LIBRARY);
};
...
const closeBACProjectLibrary = function () {
    return closeModal(MODAL_BAC_PROJECT_LIBRARY);
};
export {
    reducer as default,
